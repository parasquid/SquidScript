...
pub(crate) const BUILTIN_APP_INSTALL_METADATA: u8 = 0x1a;
...
pub(crate) const BUILTIN_SERVICE_WIFI_OPERATION: u8 = 0x57;
pub(crate) const BUILTIN_SERVICE_WIFI_RESULT: u8 = 0x58;
pub(crate) const BUILTIN_SERVICE_WIFI_CANCEL: u8 = 0x59;
pub(crate) const BUILTIN_SERVICE_WIFI_SCAN_NETWORK: u8 = 0x5a;
pub(crate) const BUILTIN_DEVICE_CONFIG_LOAD: u8 = 0x70;
