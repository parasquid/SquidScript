...
pub(crate) const BUILTIN_STATE_LOAD: u8 = 0x01;
pub(crate) const BUILTIN_STATE_SAVE: u8 = 0x02;
pub(crate) const BUILTIN_STATE_RESET: u8 = 0x03;
...
pub(crate) const BUILTIN_APP_DISARM: u8 = 0x13;
pub(crate) const BUILTIN_APP_REGISTRY_LIST: u8 = 0x14;
pub(crate) const BUILTIN_APP_REGISTRY_GET: u8 = 0x15;
...
pub(crate) const BUILTIN_SERVICE_TIMER_AFTER: u8 = 0x23;
pub(crate) const BUILTIN_DISPLAY_CLEAR: u8 = 0x30;
pub(crate) const BUILTIN_DISPLAY_TEXT: u8 = 0x31;
pub(crate) const BUILTIN_DISPLAY_RECT: u8 = 0x32;
pub(crate) const BUILTIN_DISPLAY_LINE: u8 = 0x33;
pub(crate) const BUILTIN_DISPLAY_SELECT: u8 = 0x34;
...
pub(crate) const BUILTIN_SERVICE_INDICATOR_WRITE: u8 = 0x48;
pub(crate) const BUILTIN_SERVICE_INDICATOR_TOGGLE: u8 = 0x49;
pub(crate) const BUILTIN_SERVICE_INDICATOR_READ: u8 = 0x4a;
pub(crate) const BUILTIN_SERVICE_INDICATOR_BREATHE: u8 = 0x4b;
pub(crate) const BUILTIN_SERVICE_INDICATOR_BLINK: u8 = 0x4c;
pub(crate) const BUILTIN_SERVICE_WIFI_START_AP: u8 = 0x50;
pub(crate) const BUILTIN_SERVICE_WIFI_STOP_AP: u8 = 0x51;
pub(crate) const BUILTIN_SERVICE_WIFI_STATUS: u8 = 0x52;
pub(crate) const BUILTIN_SERVICE_WIFI_GET_AP_IP: u8 = 0x53;
pub(crate) const BUILTIN_SERVICE_WIFI_CONNECT: u8 = 0x54;
pub(crate) const BUILTIN_SERVICE_WIFI_DISCONNECT: u8 = 0x55;
pub(crate) const BUILTIN_SERVICE_WIFI_SCAN: u8 = 0x56;
pub(crate) const BUILTIN_DEVICE_CONFIG_LOAD: u8 = 0x60;
pub(crate) const BUILTIN_DEVICE_CONFIG_SET: u8 = 0x61;
pub(crate) const BUILTIN_DEVICE_CONFIG_REBIND: u8 = 0x62;
pub(crate) const BUILTIN_DEVICE_CONFIG_SAVE: u8 = 0x63;
pub(crate) const BUILTIN_CONTENT_PICK_FILE: u8 = 0x70;
pub(crate) const BUILTIN_CONTENT_READ_TEXT: u8 = 0x71;
pub(crate) const BUILTIN_CONTENT_READ_LINES: u8 = 0x72;
