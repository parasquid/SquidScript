...
pub(super) fn callback_error_cases() -> Vec<CallbackCase> {
    vec![
        ...
        (
            "app install file",
            compile_app_install_sqbc(),
            |callbacks| callbacks.app_install_file = Some(failing_app_install_file),
        ),
        (
            "app registry list",
        ...
        (
            "ble start",
            compile_ble_file_transfer_trigger_sqbc(),
            |callbacks| callbacks.ble_start = Some(failing_ble_start),
        ),
        ...
        (
            "binbook chapters",
            compile_binbook_chapters_sqbc(),
            |callbacks| callbacks.binbook_chapters = Some(failing_binbook_chapters),
        ),
        (
            "binbook chapter",
            compile_binbook_chapter_sqbc(),
            |callbacks| callbacks.binbook_chapter = Some(failing_binbook_chapter),
        ),
        (
            "content binbook list",
            compile_content_binbook_sqbc(),
            |callbacks| callbacks.content_binbook_list = Some(failing_content_binbook_list),
        ),
        (
            "system memory text",
...
pub(super) fn missing_noop_cases() -> Vec<CallbackCase> {
    vec![
        ...
        ("display draw", compile_binbook_sqbc(), |callbacks| {
            callbacks.display_draw = None
        }),
        (
            "display refresh mode",
            compile_display_sqbc(),
            |callbacks| callbacks.display_refresh_mode = None,
        ),
    ]
}
...
pub(super) fn missing_required_cases() -> Vec<CallbackCase> {
    vec![
        ...
        (
            "app install file",
            compile_app_install_sqbc(),
            |callbacks| callbacks.app_install_file = None,
        ),
        (
            "app registry list",
            compile_app_registry_sqbc(),
        ...
        (
            "ble start",
            compile_ble_file_transfer_trigger_sqbc(),
            |callbacks| callbacks.ble_start = None,
        ),
        ("ble stop", compile_ble_stop_sqbc(), |callbacks| {
        ...
        (
            "system start reason text",
            compile_power_lifecycle_sqbc(),
            |callbacks| callbacks.system_start_reason_text = None,
        ),
        ("power sleep", compile_power_lifecycle_sqbc(), |callbacks| {
            callbacks.power_sleep = None
        }),
    ]
}
