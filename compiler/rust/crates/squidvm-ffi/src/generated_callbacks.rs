...
pub struct SqvmCallbacks {
    ...
    >,
    pub display_refresh_mode:
        Option<unsafe extern "C" fn(user_data: *mut c_void, mode: *const u8, mode_len: usize)>,
    pub display_info:
    ...
    >,
    pub content_binbook_list: Option<
        unsafe extern "C" fn(
            user_data: *mut c_void,
            library: *const u8,
            library_len: usize,
