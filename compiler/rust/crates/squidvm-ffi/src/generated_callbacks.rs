...
pub struct SqvmCallbacks {
    ...
    pub display_clear: Option<unsafe extern "C" fn(user_data: *mut c_void, color: u8)>,
    ...
    pub display_draw: Option< unsafe extern "C" fn( user_data: *mut c_void, drawable: SqvmHandle, options: *const SqvmDisplayResourceOptions, ), >,
    pub display_refresh_mode: Option< unsafe extern "C" fn(user_data: *mut c_void, mode: *const u8, mode_len: usize), >,
    ...
    pub ble_start: Option< unsafe extern "C" fn( user_data: *mut c_void, id: *const u8, id_len: usize, ) -> i32, >,
    pub ble_stop: Option< unsafe extern "C" fn( user_data: *mut c_void, ) -> i32, >,
    pub http_start: Option< unsafe extern "C" fn( user_data: *mut c_void, id: *const u8, id_len: usize, ) -> i32, >,
    ...
    pub file_copy: Option< unsafe extern "C" fn( user_data: *mut c_void, source: *const u8, source_len: usize, library: *const u8, library_len: usize, name: *const u8, name_len: usize, out: *mut SqvmFileCopyResult, ) -> i32, >,
    pub binbook_open: Option< unsafe extern "C" fn( user_data: *mut c_void, path: *const u8, path_len: usize, out: *mut SqvmBinBookOpenResult, ) -> i32, >,
    pub binbook_info: Option< unsafe extern "C" fn( user_data: *mut c_void, book: SqvmHandle, out: *mut SqvmBinBookInfoResult, ) -> i32, >,
    pub binbook_read_page: Option< unsafe extern "C" fn( user_data: *mut c_void, book: SqvmHandle, page_index: i32, out: *mut SqvmBinBookReadPageResult, ) -> i32, >,
    pub binbook_chapters: Option< unsafe extern "C" fn( user_data: *mut c_void, book: SqvmHandle, offset: i32, limit: i32, out: *mut SqvmBinBookChapterEntry, out_cap: usize, out_count: *mut usize, out_result: *mut SqvmBinBookChapterListResult, ) -> i32, >,
    pub binbook_chapter: Option< unsafe extern "C" fn( user_data: *mut c_void, book: SqvmHandle, index: i32, out: *mut SqvmBinBookChapterResult, ) -> i32, >,
    pub content_binbook_list: Option< unsafe extern "C" fn( user_data: *mut c_void, library: *const u8, library_len: usize, offset: i32, limit: i32, out: *mut SqvmContentBinBookEntry, out_cap: usize, out_count: *mut usize, out_result: *mut SqvmContentBinBookListResult, ) -> i32, >,
...
impl Default for SqvmCallbacks {
    fn default() -> Self {
        Self {
            ...
            binbook_chapters: None,
            binbook_chapter: None,
            content_binbook_list: None,
