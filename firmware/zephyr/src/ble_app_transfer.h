#ifndef SQUIDSCRIPT_BLE_APP_TRANSFER_H
#define SQUIDSCRIPT_BLE_APP_TRANSFER_H
...
/*
 * Custom GATT app-transfer service: the bleak/Web-Bluetooth-drivable upload
 ...
 * ble_object_transfer.h. The control characteristic carries BEGIN(name+size)/
 ...
 */
extern const uint8_t sq_ble_app_transfer_adv_uuid[16];

#ifdef __cplusplus
}
#endif

#endif /* SQUIDSCRIPT_BLE_APP_TRANSFER_H */
