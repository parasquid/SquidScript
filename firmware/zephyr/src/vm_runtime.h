...
#define SQ_VM_RUNTIME_TRACE_MAX 8
#define SQ_VM_RUNTIME_TRACE_LEN 32
#define SQ_VM_RUNTIME_OUTPUT_MAX 8
#define SQ_VM_RUNTIME_OUTPUT_LEN 56
#define SQ_VM_RUNTIME_DRAWLOG_MAX 4
#define SQ_VM_RUNTIME_DRAWLOG_LEN 64
...
#else
#define SQ_VM_RUNTIME_CONTEXT_BYTES 11776
#endif
#define SQ_VM_RUNTIME_SCRATCH_BYTES SQVM_STORAGE_TRANSFER_CAPACITY
#define SQ_VM_RUNTIME_WORK_STACK_SIZE 18432
