...
impl AuthenticationMethod {
    ...
    /// Convert a raw ESP-IDF Wi-Fi authentication mode into an authentication method.
    pub fn from_raw(raw: wifi_auth_mode_t) -> Self {
        match raw {
...
ignored."
    ...
    /// Start the configured Wi-Fi interfaces.
    ...
    /// Start Wi-Fi station association without waiting for the connected or
    /// disconnected event.
    pub fn connect_station(&mut self) -> Result<(), WifiError> {
        self.connect_impl()
    }
