...
class ZephyrFfiAbiTests(ZephyrScriptTestCase):
    def test_squidvm_ffi_abi_checker_validates_current_manifest(self):
        ...
        self.assertIn("app_install_file", callback_fields)
...
""",
    ...
    def test_vm_context_reserve_tracks_current_ffi_size(self):
        ...
        self.assertIn("const ZEPHYR_RUNTIME_CONTEXT_BYTES: usize = 9_216;", ffi_rs)
        self.assertIn("#define SQ_VM_RUNTIME_CONTEXT_BYTES 9216", runtime_h)
        self.assertIn("SQ_VM_RUNTIME_CONTEXT_BYTES <= 9216", ztest)
