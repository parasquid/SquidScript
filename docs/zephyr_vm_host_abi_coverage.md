...
- Exports: 62
- Callback fields: 63
- Generated result-default records: 16
- Public ABI types: 122
...
| binbook | binbook_open, binbook_info, binbook_read_page, binbook_chapters, binbook_chapter | Rust FFI dispatch BinBook tests | BinBook resource and chapter ztests | 5 |
